 ...
 ******************************************************************************/
public class PostCourseRegisterVoucherAsyncTask extends BaseAsyncTask{
    /***************************************************************************
     * インスタンス変数
     ***************************************************************************/
    private String  delivery_date;                              //配送日
    private String  voucher_no;                                 //伝票番号
    private int     course_id;                                  //コースID
     ...
     * @brief コンストラクタ
     */
    public PostCourseRegisterVoucherAsyncTask(Context context, AsyncTaskCallbacks callback ) {
        super( context, callback );
        this.request_code	= RequestCode.REQ_CODE_POST_COURSE_REGISTER_VOUCHER;
    }
    ...
    protected int pre_proc( String... params ){
        ...
        if( params.length == 0 ) {
            ...
            voucher_no	    = params[6];
            course_id	    = Integer.parseInt( params[7] );
        }
    ...
    protected int main_proc(){
        ...
        //実行
        ret = command.post_course_register_voucher( delivery_date, course_id, voucher_no );
