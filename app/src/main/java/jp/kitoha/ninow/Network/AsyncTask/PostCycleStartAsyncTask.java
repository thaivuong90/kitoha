...
/******************************************************************************
 * @brief		センター到着報告通信処理クラス
 * @author 		KITOHA	N.Endo
 * @since		2015 -
 * @copyright	(c)KITOHA.co., ltd All right reserved.
 ******************************************************************************/
public class PostCycleStartAsyncTask extends BaseAsyncTask {
	/***************************************************************************
	 * インスタンス変数
	 ***************************************************************************/
	String			current_date;
	 ...
	 * @brief コンストラクタ
	 */
	public PostCycleStartAsyncTask( Context context, AsyncTaskCallbacks callback ) {
		super( context, callback );
		this.request_code	= RequestCode.REQ_CODE_POST_CYCLE_START;
	...
	protected int main_proc(){
		...
		//実行
		ret = command.post_cycle_reports( HttpCommand.TYPE_NO_START, latitude, longitude, accuracy, current_date, report_time );
