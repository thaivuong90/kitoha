...
public class PostDeliveryAbsenceAsyncTask extends BaseAsyncTask {
	 ...
	 * @brief コンストラクタ
	 */
	public PostDeliveryAbsenceAsyncTask( Context context, AsyncTaskCallbacks callback ) {
	...
	protected int main_proc(){
		...
		ret = command.post_delivery_report( delivery_date, instruct_no, voucher_no,
			HttpCommand.TYPE_NO_ABSENCE, status, reject_reason, latitude, longitude, accuracy );
