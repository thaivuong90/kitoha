...
/******************************************************************************
 * @brief		動画アップロード通信処理クラス
 * @author 		KITOHA	N.Endo
 * @since		2015 -
 * @copyright	(c)KITOHA.co., ltd All right reserved.
 ******************************************************************************/
public class PostMediasAsyncTask extends BaseAsyncTask {
	/***************************************************************************
	 * インスタンス変数
	 ***************************************************************************/
	 ...
	 * @brief コンストラクタ
	 */
	public PostMediasAsyncTask( Context context, AsyncTaskCallbacks callback ) {
		super( context, callback );
		this.request_code	= RequestCode.REQ_CODE_POST_MEDIAS;
	}
	...
	protected int main_proc(){
		...
		//実行
		ret = command.post_medias( delivery_date, instruct_no, transmission_order_no, type,
			file, latitude, longitude, accuracy );
