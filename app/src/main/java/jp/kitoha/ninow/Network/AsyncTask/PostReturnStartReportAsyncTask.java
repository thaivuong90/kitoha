 ...
 ******************************************************************************/
public class PostReturnStartReportAsyncTask extends BaseAsyncTask {
	/***************************************************************************
	 * インスタンス変数
	 ***************************************************************************/
	String			current_date;
	 ...
	 * @brief コンストラクタ
	 */
	public PostReturnStartReportAsyncTask( Context context, AsyncTaskCallbacks callback ) {
		super( context, callback );
		this.request_code	= RequestCode.REQ_CODE_POST_RETURN_START;
	...
	protected int main_proc(){
		...
		run_info.setDeliveryLastTime( report_time );

		//実行
		ret = command.post_return_report( HttpCommand.TYPE_NO_START,
