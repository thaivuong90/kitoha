 ...
 ******************************************************************************/
public class PostStartingReportAsyncTask extends BaseAsyncTask {
	/***************************************************************************
	 * インスタンス変数
	 ***************************************************************************/
	String			current_date;
	 ...
	 * @brief コンストラクタ
	 */
	public PostStartingReportAsyncTask( Context context, AsyncTaskCallbacks callback ) {
		super( context, callback );
		this.request_code	= RequestCode.REQ_CODE_POST_STARTING_REPORT;
	...
	protected int main_proc(){
		...
		run_info.setStartingReportTime( report_time );

		//実行
		ret = command.post_starting_report( delivery_date, instruct_no, latitude, longitude, accuracy, current_date, report_time );
