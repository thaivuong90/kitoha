 ...
 ******************************************************************************/
public class UpdateCourseInfoAsyncTask extends BaseAsyncTask {
	/***************************************************************************
	 * インスタンス変数
	 ***************************************************************************/
	 ...
	 * @brief コンストラクタ
	 */
	public UpdateCourseInfoAsyncTask( Context context, AsyncTaskCallbacks callback ) {
		super( context, callback );
		this.request_code	= RequestCode.REQ_CODE_UPDATE_COURSE_INFO;
	}
	...
	protected int main_proc(){
		...
		//実行
		ret = command.update_course_info( delivery_date, instruct_no );
